...
alias update='sudo apt update && sudo apt full-upgrade -y && sudo apt autoremove --purge -y && sudo apt clean all -y'
...
# add md, mkdir then cd
md () { [ $# = 1 ] && mkdir -p "$@" && cd "$@" || echo "Error - no directory passed!"; }

alias bootwin='sudo grub-reboot 2 && sudo reboot'

export PATH=$PATH:/home/sunmi/.local/bin
